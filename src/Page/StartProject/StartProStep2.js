  ...
  return (
    <>
      <div className="container-grid">
        ...
        <p className="d-flex justify-content-center text-secondary"><h3>เลือกระดับเพื่อค้นหาทีมที่เหมาะกับโปรเจคของเรา</h3></p>
        <Form.Group className="mt-5">
          <Form.Check type="radio" id={1} name="projectSeriousnessId" value={1} inline onChange={setFormdata} checked={projectSeriousnessToInt === 1} />
          <label for={1}><b>งานอดิเรก:</b> เป็นประเภทที่ไม่จริงจังมากเกินไป อยากทดสอบไอเดียของโปรเจคว่าเป็นจริงได้มากแค่ไหน</label><br />
          <Form.Check type="radio" id={2} name="projectSeriousnessId" value={2} inline onChange={setFormdata} className="mt-4" checked={projectSeriousnessToInt === 2} />
