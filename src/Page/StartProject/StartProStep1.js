...
export function StartProStep1({ formdata, setFormdata }) {
  ...
  return (<Form className="justify-content-md-center ">
    ...
    <Form.Control label="project Name" name="projectName" type="text" value={projectName} placeholder="" onChange={(e) => setFormdata({ ...formdata, projectName: e.target.value })}></Form.Control>
    ...
    <Form.Select name="projectCategoryId" value={projectCategoryId} onChange={(e) => setFormdata({ ...formdata, projectCategoryId: e.target.value })} defaultValue={6}>
