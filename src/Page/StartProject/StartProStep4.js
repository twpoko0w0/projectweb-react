      ...
      <Form as={Row} className="mt-5">
        <div className="shadow p-3 mb-5 bg-body rounded">
          <Row>
            ...
            <Col xs={12} md={2}>
              <Form.Select name="projectPositionQuantity" value={projectPositionQuantity} onChange={setFormdata}>
          ...
          <Form.Select value={projectTagId} name="projectTagId" onChange={setFormdata}>
            {projectTagElement}
          </Form.Select>
          <Form.Label className="mt-4">ตำแหน่งนี้มีหน้าที่อะไร</Form.Label>
          <Form.Control label="projectRole" name="projectRole" type="text" value={projectRole} placeholder="" onChange={setFormdata} as="textarea"></Form.Control>
          <Button
            className="Plus mt-4"
            type="addicon"
            variant="primary"
            style={{ width: "124px", height: "44px", padding: "10px" }}
            onClick={AddList}
          >
            <img src={Add} alt="ADD" />
            เพิ่มลงลิสต์
