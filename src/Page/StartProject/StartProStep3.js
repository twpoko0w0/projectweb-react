  ...
  return (
    <>
      ...
      <Form style={{ background: "#fff", padding: "20px" }}>
        ...
        <Form.Control label="projectBriefDetail" name="projectBriefDetail" type="text" value={projectBriefDetail} placeholder="กรอกข้อมูล" onChange={setFormdata} as="textarea"></Form.Control>
        <p>{text.length}/350</p>
        <Form.Label className="mt-4">รายละเอียดทั้งหมด (เฉพาะคนในทีม)</Form.Label>
        <Form.Control label="projectDetail" name="projectDetail" type="text" value={projectDetail} placeholder="กรอกข้อมูล" onChange={setFormdata} as="textarea" style={{ height: "144px" }}></Form.Control>
        <div className="Box-drop">
          <Row>
            <Col>
              <Form.Label className="mt-3">สถานะของโปรเจค</Form.Label>
              <Form.Select name="projectStatusId" value={projectStatusId} onChange={setFormdata}>
            ...
            <Col>
              <Form.Label className="mt-3">สถานะของโปรเจค</Form.Label>
              <Form.Select name="projectDurationId" value={projectDurationId} onChange={setFormdata}>
      ...
      <Form style={{ marginTop: "40px", background: "#fff", padding: "20px" }}>
        ...
        <Form.Group as={Row} className="mt-3">
          <Col>
            ...
            <Form.Control label="projectContact" name="projectContact.facebook" type="text" value={projectContact.facebook} placeholder="" onChange={setFormdata} ></Form.Control>
          </Col>
          <Col>
